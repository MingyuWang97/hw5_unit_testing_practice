...
class TestCard(unittest.TestCase):
    ...
    def test_q8(self):
        ...
        '''
        d1 = hw5_cards.Deck()
        c1 = hw5_cards.Card(2,3)  # randomly instantiate a card
        num1 = len(d1.cards) # number of cards before replace_card with a card that is already in the deck
        d1.replace_card(c1)
        num2 = len(d1.cards) # number of cards after replace_card with a card that is already in the deck
